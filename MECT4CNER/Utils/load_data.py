...
@cache_results(_cache_fp='cache/dark', _refresh=False)
def load_dark_data(path, char_embedding_path=None, bigram_embedding_path=None, index_token=True,
                   char_min_freq=1, bigram_min_freq=1, only_train_min_freq=0):
    train_path = os.path.join(path, 'input_darkdata.bmes')
    dev_path = os.path.join(path, 'input_darkdata.bmes')
    test_path = os.path.join(path, 'input_darkdata.bmes')
...
@cache_results(_cache_fp='cache/thu', _refresh=False)
def load_thu_data(path, char_embedding_path=None, bigram_embedding_path=None, index_token=True,
                  char_min_freq=1, bigram_min_freq=1, only_train_min_freq=0):
    train_path = os.path.join(path, 'THUCNews.bmes')
    dev_path = os.path.join(path, 'THUCNews.bmes')
    test_path = os.path.join(path, 'THUCNews.bmes')
...
@cache_results(_cache_fp='cache/wiki', _refresh=False)
def load_wiki_data(path, char_embedding_path=None, bigram_embedding_path=None, index_token=True,
                   char_min_freq=1, bigram_min_freq=1, only_train_min_freq=0):
    train_path = os.path.join(path, 'wiki.bmes')
    dev_path = os.path.join(path, 'wiki.bmes')
    test_path = os.path.join(path, 'wiki.bmes')
